...
<div id="formContent">
        ...
        <br>
        <input type="text" id="aadharNum" name="aadharNum" maxlength="12" onkeypress="inputNumber(event)" placeholder="Aadhar Number" required>
        <br>
        <input type="password" id="re-aadharNum" maxlength="12" name="re-aadharNum" placeholder="Re-enter Aadhar Number" onkeypress="inputNumber(event)" required>
    ...
    function inputNumber(evt)
    {
      ...
      else if(document.getElementById("aadharNum").length < 12)
      {
