...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="POST" action="loggedin.php">
...
<hr>
    ...
    <div class="container" style="background-color:#f1f1f1">
      <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn"><b>Cancel</b></button>
        <button id="loginbtn" name="submit" type="submit" method="POST" onclick="login()" style="float: right" class="loginbtn"><b>Login</b></button>
...
//checking the lenght of Password
function passwordvalidation()
{
  if(document.getElementById("pass").value.length <= 9)
  {
...
//validate the password is empty
// function emptypassword()
// {
//   if (document.getElementById("pass").value.length == 0)
//   {
//     alert("Please enter the password and then proceed");
//   }
//   else
//   {
//     document.getElementById("signupbtn").disabled = false;
